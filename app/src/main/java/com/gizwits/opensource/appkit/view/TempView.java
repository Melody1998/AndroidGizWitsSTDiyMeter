...
import com.gizwits.opensource.appkit.utils.ColorUtils;
...
public class TempView extends View {
    ...
    public void setValue(float value, String showText) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String showText = this.showText == null ? (int) (currentValue / 360f * 100) + "%" : this.showText;
        canvas.drawText(showText, width / 2, baseLine, paint);
    }
